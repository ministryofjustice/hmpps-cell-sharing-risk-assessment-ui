...
export enum Page {
  ...
  PRISONER_CSRA_CONFIRM_RATING = 'PRISONER_CSRA_CONFIRM_RATING',
  PRISONER_CSRA_HISTORY = 'PRISONER_CSRA_HISTORY',
  PRISONER_CSRA_REVIEW = 'PRISONER_CSRA_REVIEW',
  PRISONER_CSRA_QUESTION = 'PRISONER_CSRA_QUESTION',
  PRISONER_CSRA_TASK_LIST = 'PRISONER_CSRA_TASK_LIST',
  PRISONER_CSRA_WARRANTS = 'PRISONER_CSRA_WARRANTS',
