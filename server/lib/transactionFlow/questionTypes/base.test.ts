...
describe('Question base class', () => {
  it('stores constructor values on the instance', () => {
    ...
    expect(question.componentAttributes(undefined, {}, {} as CsraAssessment)).toEqual({ id: 'questionId' })
    expect(question.getFormValues({} as CsraAssessment)).toEqual({ questionId: 'value' })
  })
})
